...
public class CustomerResource {
	...
	private static final String SIZE_OF_2 = "2";
	...
	public Customers getCustomers(@QueryParam(START) int start, 
			@QueryParam(SIZE) @DefaultValue(SIZE_OF_2) int size,
		...
		synchronized (customerDB) {
			int i = 0;
			// Construct the list of customers to return using "start" and 'size"
