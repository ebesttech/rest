...
import com.jpassion.domain.Order;
import com.jpassion.domain.Orders;
...
public class OrderResource {
	...
	@HEAD
	@Produces("application/xml")
	public Response getOrdersHeaders(@QueryParam("start") int start, @QueryParam("size") @DefaultValue("2") int size,
			@Context UriInfo uriInfo) {
		Response.ResponseBuilder builder = Response.ok();
		builder.type("application/xml");
